...
exports.route_update_post = function (req, res) {
    Route.findByIdAndUpdate(req.params.id, {$set: req.body}, function (err, res) {
        if (err)
            console.log(err)//return next(err);
...
exports.route_delete = function (req, res) {
    Route.findByIdAndRemove(req.params.id, {$set: req.body}, function (err, res) {
        if (err)
            console.log(err)//return next(err);
